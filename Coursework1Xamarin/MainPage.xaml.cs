        ...
        private async void btnSubmit_Clicked(object sender, EventArgs e)
        {
            ...
            if (response)
            {
                Hike h = new Hike(count++, this.txtName.Text,
                    this.txtLocation.Text, this.dtpDate.Date,this.swtAvailability.IsToggled,
                    this.txtLength.Text, this.cbxLevel.SelectedItem.ToString(), this.txtDescription.Text);
